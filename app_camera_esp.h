 ...
 */
#define CAMERA_PIXEL_FORMAT PIXFORMAT_GRAYSCALE //PIXFORMAT_RGB888 //PIXFORMAT_GRAYSCALE
...
#else
#define CAMERA_FRAME_SIZE FRAMESIZE_96X96 //FRAMESIZE_96X96 //FRAMESIZE_QQVGA
#endif
